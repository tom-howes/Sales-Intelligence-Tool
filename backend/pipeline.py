...
def generate_brief(
    ...
    if rag_context:
        chunks = "\n\n---\n\n".join(rag_context)
        rag_block = f"""
<internal_seller_docs>
The following content is extracted from internal seller documents (e.g. battlecards, one-pagers, architecture docs).
This content takes precedence over the scraped seller website where there is any conflict.
